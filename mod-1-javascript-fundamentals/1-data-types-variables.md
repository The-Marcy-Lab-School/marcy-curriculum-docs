...
* [Summary](1-data-types-variables.md#summary)
* [Computation is All About Data](1-data-types-variables.md#computation-is-all-about-data)
* [Data Types](1-data-types-variables.md#data-types)
* [Operators](1-data-types-variables.md#operators)
  * [Ternary Operator](1-data-types-variables.md#ternary-operator)
  * [typeof Operator](1-data-types-variables.md#typeof-operator)
  * [Resolution Order of Operations](1-data-types-variables.md#resolution-order-of-operations)
* [Type Coercion & Truthy vs. Falsy](1-data-types-variables.md#type-coercion--truthy-vs-falsy)
* [Variables](1-data-types-variables.md#variables)
  * [Using Variables: Declare, Assign, Reference](1-data-types-variables.md#using-variables-declare-assign-reference)
  * [Scope](1-data-types-variables.md#scope)
  * [The Four Ways To Declare Variables](1-data-types-variables.md#the-four-ways-to-declare-variables)
  * [Hoisting: Why We Don't Use `var`](1-data-types-variables.md#hoisting-why-we-dont-use-var)
...
There are 4 ways to declare a new variable, _but only the first two of should be used_:
