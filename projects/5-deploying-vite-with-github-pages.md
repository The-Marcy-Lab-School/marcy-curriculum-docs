...
![When visiting a static website, the server will send HTML, CSS, and JS files to the client](../.gitbook/assets/client-server-interaction-2.png)
...
![Select your deployment source. Choose GitHub Actions](../.gitbook/assets/select-deploy-source.png)

5. Then click on **Actions** and select **set up a workflow yourself**

![Create your own action.](../.gitbook/assets/create-your-own-action.png)
