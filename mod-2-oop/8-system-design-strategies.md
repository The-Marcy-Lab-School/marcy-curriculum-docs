...
* [Design Challenge: A School System](8-system-design-strategies.md#design-challenge-a-school-system)
* [System Design Strategies and Principles](8-system-design-strategies.md#system-design-strategies-and-principles)
  * [System Design Strategies](8-system-design-strategies.md#system-design-strategies)
    * [The Coordinator Pattern](8-system-design-strategies.md#the-coordinator-pattern)
    * [Status-Driven Behavior](8-system-design-strategies.md#status-driven-behavior)
    * [The Intermediary Object Pattern](8-system-design-strategies.md#the-intermediary-object-pattern)
  * [Common Design Decisions](8-system-design-strategies.md#common-design-decisions)
    * [Private vs. Public Properties](8-system-design-strategies.md#private-vs-public-properties)
    * [Bidirectional References](8-system-design-strategies.md#bidirectional-references)
    * [Creator Responsibility](8-system-design-strategies.md#creator-responsibility)
* [System Design Strategies Summary](8-system-design-strategies.md#system-design-strategies-summary)
...
* The system tracks _which_ adopter applied for _which_ pet, the current status, etc., _per-application_.
...
* You don't put the grade on the `Student` or the `Course`—it lives on the _Enrollment object_ because it relates specifically to that pairing.
