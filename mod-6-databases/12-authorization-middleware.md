...
{% hint style="info" %}
Follow along with code examples [here](https://github.com/The-Marcy-Lab-School/6-12-authorization-middleware)!
{% endhint %}
...
Here is the full authentication and authorization system built across lessons 10–12:
