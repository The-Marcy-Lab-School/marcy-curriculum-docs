...
You are *strongly encouraged* to choose an API from this [list of free APIs](../projects/free-apis.md) as they are all free and, importantly, do not require an API key. 
