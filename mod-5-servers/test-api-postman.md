...
![A collection on Postman is used to organize API calls for a single project](<../.gitbook/assets/postman-collections (1).png>)
...
![A POST request with a JSON body is received by the server and a response is sent. Postman displays the response.](<../.gitbook/assets/postman-testing (1).png>)
