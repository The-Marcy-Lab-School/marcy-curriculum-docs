...
* [Explore the Solution](case-study.md#explore-the-solution)
  * [Trace the Flow](case-study.md#trace-the-flow)
    * [Scenario 1: The page loads and bookmarks are rendered on the screen](case-study.md#scenario-1-the-page-loads-and-bookmarks-are-rendered-on-the-screen)
    * [Scenario 2: The user fills out the form and submits a new bookmark](case-study.md#scenario-2-the-user-fills-out-the-form-and-submits-a-new-bookmark)
    * [Scenario 3: The user clicks the Delete button on a bookmark](case-study.md#scenario-3-the-user-clicks-the-delete-button-on-a-bookmark)
...
![Controllers use the Fellow Model interface to update the "database" before sending a response back to the client.](../.gitbook/assets/express-middleware-model.jpg)
