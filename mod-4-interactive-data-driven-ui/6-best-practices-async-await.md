...
* [Key Concepts](6-best-practices-async-await.md#key-concepts)
* [Intro: Promises Are Tricky](6-best-practices-async-await.md#intro-promises-are-tricky)
  * [So many `.then()` calls](6-best-practices-async-await.md#so-many-then-calls)
* [Async / Await](6-best-practices-async-await.md#async--await)
  * [What about Errors? Try and Catch](6-best-practices-async-await.md#what-about-errors-try-and-catch)
  * [The benefits of `async`/`await`](6-best-practices-async-await.md#the-benefits-of-asyncawait)
* [Best Practice: Standardize the Return Structure](6-best-practices-async-await.md#best-practice-standardize-the-return-structure)
* [Best Practice: Fetch Helper Functions](6-best-practices-async-await.md#best-practice-fetch-helper-functions)
...
One common solution to this is to _always_ return an object with `data` and `error` properties:
...
We _could_ do something like `if (result instanceof Error)` to determine if the value is an `Error` object but it is entirely possible that the API we are fetching from has data in an error-like object.
