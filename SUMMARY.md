...
* [Mod 5 - Backend Servers & Databases](mod-5-backend/README.md)
  ...
  * **Part I: Servers & APIs**
  * [1. How the Internet Works, Part 1](mod-5-backend/1-how-the-internet-works-1.md)
  * [2. How the Internet Works, Part 2](mod-5-backend/2-how-the-internet-works-2.md)
  * [3. Server Basics with node:http](mod-5-backend/3-server-basics-http-server.md)
  * [4. Intro to Express](mod-5-backend/4-intro-to-express.md)
  * [5. Middleware & Serving Static Assets](mod-5-backend/5-middleware-static-assets.md)
  * [6. Environment Variables & Deployment](mod-5-backend/6-environment-variables-deployment.md)
  * [7. RESTful CRUD API](mod-5-backend/7-rest-crud-api.md)
  * [8. Model-View-Controller Architecture](mod-5-backend/8-model-view-controller.md)
  * **Part II: Databases, Full Stack & Auth**
  * [9. SQL and Databases](mod-5-backend/9-sql-and-databases.md)
  * [10. Schema Design & Normalization](mod-5-backend/10-schema-design-normalization.md)
  * [11. Connecting to Postgres with pg](mod-5-backend/11-connecting-to-postgres-pg.md)
  * [12. Async Patterns with pg](mod-5-backend/12-async-patterns-pg.md)
  * [13. JOIN Queries](mod-5-backend/13-join-sql-queries.md)
  * [14. Building a Fullstack App](mod-5-backend/14-fullstack-app.md)
  * [15. Hashing Passwords with Bcrypt](mod-5-backend/15-hashing-passwords-bcrypt.md)
  * [16. Sessions & Login](mod-5-backend/16-sessions-login.md)
  * [17. Authorization Middleware](mod-5-backend/17-authorization-middleware.md)
