...
* [Environment Setup](environment-setup/README.md)
  ...
  * [Postgres Setup](fenvironment-setup/postgres-setup.md)
* [Fullstack Software Engineering Curriculum](fullstack-curriculum/README.md)
  ...
  * [How-Tos](fullstack-curriculum/how-tos/README.md)
    * [How To Code at Marcy: Code Style Guide](fullstack-curriculum/how-tos/style-guide.md)
    ...
    * [How to Create Projects with Vite](fullstack-curriculum/how-tos/vite.md)
  ...
  * [Mod 1 - JavaScriptFundamentals](fullstack-curriculum/mod-1-javascript-fundamentals/README.md)
    ...
    * [Errors](fullstack-curriculum/mod-1-javascript-fundamentals/1-errors.md)
    * [Node & Node Modules](fullstack-curriculum/mod-1-javascript-fundamentals/2-node-and-modules.md)
    * [Variables, Functions & String Methods](fullstack-curriculum/mod-1-javascript-fundamentals/3-variables-functions-strings.md)
    * [Control Flow, `typeof`, and Math](fullstack-curriculum/mod-1-javascript-fundamentals/4-control-flow.md)
    * [Loops](fullstack-curriculum/mod-1-javascript-fundamentals/5-loops.md)
    * [Arrays](fullstack-curriculum/mod-1-javascript-fundamentals/6-arrays.md)
    * [Objects](fullstack-curriculum/mod-1-javascript-fundamentals/7-objects.md)
    * [Higher Order Functions: Callbacks](fullstack-curriculum/mod-1-javascript-fundamentals/8-hof-callbacks.md)
    * [Higher Order Functions: Array Methods](fullstack-curriculum/mod-1-javascript-fundamentals/9-hof-array-methods.md)
    * [Regex](fullstack-curriculum/mod-1-javascript-fundamentals/10-regex.md)
  * [Mod 2 - HTML, CSS & the DOM](fullstack-curriculum/mod-2-html-css-dom/README.md)
    ...
    * [HTML](fullstack-curriculum/mod-2-html-css-dom/html.md)
    * [CSS](fullstack-curriculum/mod-2-html-css-dom/css.md)
    * [Accessibility (a11y)](fullstack-curriculum/mod-2-html-css-dom/accessibility.md)
    * [The Document Object Model (DOM) API](fullstack-curriculum/mod-2-html-css-dom/intro-to-dom.md)
    * [Events](fullstack-curriculum/mod-2-html-css-dom/events.md)
    * [Forms](fullstack-curriculum/mod-2-html-css-dom/forms.md)
    * [The Box Model and Positioning](fullstack-curriculum/mod-2-html-css-dom/box-model.md)
    * [Flexbox](fullstack-curriculum/mod-2-html-css-dom/flexbox.md)
    * [Grid & Media Queries](fullstack-curriculum/mod-2-html-css-dom/grid-media-queries.md)
    * [ESModules](fullstack-curriculum/mod-2-html-css-dom/esmodules.md)
    * [Vite](fullstack-curriculum/how-tos/vite.md)
    * [LocalStorage](fullstack-curriculum/mod-2-html-css-dom/localStorage.md)
