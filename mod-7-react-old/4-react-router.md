...
* [Terms](4-react-router.md#terms)
* [React Router Basics](4-react-router.md#react-router-basics)
* [Using React Router](4-react-router.md#using-react-router)
  * [0) Install the package `react-router-dom`](4-react-router.md#0-install-the-package-react-router-dom)
  * [1) Render a `<BrowserRouter>`](4-react-router.md#1-render-a-browserrouter)
  * [2) Create your `<Routes>` and `<Route>`s](4-react-router.md#2-create-your-routes-and-routes)
  * [3) Create `<Link>`s](4-react-router.md#3-create-links)
* [Fallback Component](4-react-router.md#fallback-component)
* [Creating a Product Page](4-react-router.md#creating-a-product-page)
  * [I want to render a page to display a single product...](4-react-router.md#i-want-to-render-a-page-to-display-a-single-product)
  * [Path Parameters](4-react-router.md#path-parameters)
  * [`useParams`](4-react-router.md#useparams)
  * [Rendering a dynamic list of links](4-react-router.md#rendering-a-dynamic-list-of-links)
* [Route Specificity](4-react-router.md#route-specificity)
* [Nesting Routes](4-react-router.md#nesting-routes)
