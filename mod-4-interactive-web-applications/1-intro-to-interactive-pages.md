...
- [From Scratch Challenge: Speed Clicker](#from-scratch-challenge-speed-clicker)
...
## From Scratch Challenge: Speed Clicker

In the `2-speed-clicker/` folder, build a "Speed Clicker" game from Scratch
...
**<details><summary>Starter Code (if you need help)</summary>**
