...
![A collection on Postman is used to organize API calls for a single project](./img/test-api-postman/postman-collections.png)
...
![A POST request with a JSON body is received by the server and a response is sent. Postman displays the response.](./img/test-api-postman/postman-testing.png)
