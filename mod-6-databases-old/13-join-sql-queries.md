...
* [Essential Questions](13-join-sql-queries.md#essential-questions)
* [Terms](13-join-sql-queries.md#terms)
* [How should I create my database?](13-join-sql-queries.md#how-should-i-create-my-database)
* [Two Tables and Foreign Keys](13-join-sql-queries.md#two-tables-and-foreign-keys)
* [Association SQL Queries](13-join-sql-queries.md#association-sql-queries)
  * [Setup](13-join-sql-queries.md#setup)
  * [Some Questions To Answer](13-join-sql-queries.md#some-questions-to-answer)
* [Entity Relation Diagrams and Many To Many Relationships](13-join-sql-queries.md#entity-relation-diagrams-and-many-to-many-relationships)
...
![ERD with one to many and many to many relationships](<../.gitbook/assets/labeled-erd (4).png>)
